...
import { PenIcon, TagIcon, QuestionIcon } from "@/components/illustrations/MiscIcons";
import { ClipboardIcon } from "@/components/illustrations/ProcessIcons";
...
const categoryIcons: Record<string, typeof TagIcon> = {
  Pricing: TagIcon,
  Process: ClipboardIcon,
  "Small Business": QuestionIcon,
};
      ...
      <Section className="pt-20 sm:pt-28">
        <Container>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <Badge className="mx-auto mt-6">Blog</Badge>
      ...
      <Section className="pt-0">
        <Container className="max-w-3xl">
          <div className="divide-y divide-border border-y border-border">
            {blogPosts.map((post) => {
              const Icon = categoryIcons[post.category] ?? TagIcon;
              return (
                <Link
                  key={post.slug}
                  href={`/blog/${post.slug}`}
                ...
                >
                  <div className="hidden h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-brand-light text-brand sm:flex">
